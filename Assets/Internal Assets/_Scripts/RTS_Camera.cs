...
public class RTS_Camera : MonoBehaviour
{
    ...
    public static CameraMoveEvent OnCameraMoved = new CameraMoveEvent();
    ...
    private void HeightCalculation()
    {
        ...
        //ZOOM BEHAVIOURS===============================================================================================
        transform.rotation = Quaternion.Euler(Mathf.Lerp(78f, 78f, zoomPos * 2f), transform.rotation.y, transform.rotation.z);
        ...
        // if (targetHeight >= (minHeight + 3))
        // {
        //     RenderSettings.skybox = CameraController.Instance.atmoSkyboxMat;
        // }
        // else
        // {
        //     RenderSettings.skybox = CameraController.Instance.skyboxMat;
